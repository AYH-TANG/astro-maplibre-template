...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    <img src="https://reurl.cc/O5VvQy" alt="image description" />
    ...
    <img src="https://reurl.cc/O5VvQy" alt="An illustration depicting the location that people can find salt." />

    ### How to use Salt? 
    And even more detail here.
    <img src="https://reurl.cc/O5VvQy" alt="An illustration depicting the cyclical process of salt formation, harvesting, refinement, and its various applications." />
