...
import fiskImg from "../assets/img/Mapping the Salt.jpg"
...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    <img src="C:\Users\sweet\Documents\GitHub\astro-maplibre-template\src\assets\img\Timeline_ Salt Industrilization" alt="image description" />
