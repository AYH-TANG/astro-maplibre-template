...
import SaltIndustrilization from "public/img/Timeline_ Salt Industrilization.png"
...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    <Container>
    # Salt: The Small Element with a Big Impact on People
    
    What I aim to achieve may seem modest, yet it profoundly impacts all living creatures in countless ways.
    <MapLibre
    ...
    <img src="...Documents\GitHub\astro-maplibre-template\public\img" alt="image description" />

    ## Where is Salt? 

    To highlight the importance of salt in our lives, I aim to map the locations where salt can be found and where it is produced.

    <img src="...Documents\GitHub\astro-maplibre-template\public\img\Timeline_ Salt Industrilization" alt="An illustration depicting the location that people can find salt." />

    ### How to use Salt? 
    And even more detail here.
    <img src="...Documents\GitHub\astro-maplibre-template\public\img\Timeline_ Salt Industrilization" alt="An illustration depicting the cyclical process of salt formation, harvesting, refinement, and its various applications." />
