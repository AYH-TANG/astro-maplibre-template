...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    Take Qigu Salt Fields in Tainan, Taiwan as an example. The coastal areas in were among the earliest salt production sites established by Han settlers. During Japanese rule, salt production expanded significantly to support industrial demands. Although large-scale salt production ceased in the late 20th century, the salt fields evolved into vital wetlands, fostering rich biodiversity and serving as a sanctuary for migratory birds. At the same time, salt remains deeply ingrained in local culture, inspiring unique culinary creations like tofu pudding and "salted watermelon."
