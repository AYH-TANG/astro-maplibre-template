...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    The picture comes from the article "As Ice Melts, the Inuit Strive to Keep Their Culture Alive" from Discovery Magazine (September 2019), an Inuit girl is depicted collecting and drinking sea water directly, confused me intrigued me. In fact, this practice is explained by the fact that as sea ice ages, the salt sinks into the ocean, leaving fresh, drinkable water on top. 
    ...
    ## Visible and Invisible - Where to find Salt? 
    ...
    ## Global and Local - Salt as a Crystal of Time and Space
    
    I begin this story in a place that could be described as having "no salt" and gradually shift focus to a region abundant in salt, highlighting its local significance. 
    
    <img src={chigu.src} alt="image description" />
    
    Take Qigu Salt Fields in Tainan, Taiwan as an example. The coastal areas in Tainan were among the earliest salt production sites established by Han settlers. During Japanese rule, salt production expanded significantly to support industrial demands. Although large-scale salt production ceased in the late 20th century, the salt fields evolved into vital wetlands, fostering rich biodiversity and serving as a sanctuary for migratory birds. At the same time, salt remains deeply ingrained in local culture, inspiring unique culinary creations like tofu pudding and "salted watermelon."
    
    <img src={tofu_pudding.src} alt="image description" />
    <img src={watermelon_2.src} alt="image description" />
