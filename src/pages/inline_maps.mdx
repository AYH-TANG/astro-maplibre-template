...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    <img src="public/img/Timeline_ Salt Industrilization.png" alt="image description" />
    ...
    <img src="astro-maplibre-template/public/img/Timeline_ Salt Industrilization.jpg" alt="image description" />
