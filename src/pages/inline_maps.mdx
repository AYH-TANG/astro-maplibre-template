...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    <img src={salt_landscape_land.src} alt="image description" />

    <img src={salt_landscape_water.src} alt="image description" />

    <img src={special_salt.src} alt="image description" />
